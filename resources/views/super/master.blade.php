...
<head>
  ...
  <title>URGENT3K | SUPERDASHBOARD</title>
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>Welcome to Secureloan</h4>
                <p>Create a loan to protect your transactions</p>
                <p>30 min. ago</p>
              </div>
            </li>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            @if($user->logo !== null)
            <img class="rounded-circle" src="{{ asset('brand_images/'.$user->logo.'')}}" alt="Profile Pic">
            @else
            <img class="rounded-circle" src="assets/img/profile-img.jpg" alt="Profile Pic">
            @endif
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center"
                onclick='return confirm("Are you sure you want to logout?")' href="/logout">
      ...
      <div id="navbarVerticalMenuPagesMenu">
        ...
        <li class="nav-item">
          ...
          <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
              <a href="/allloans">
                <i class="bi bi-circle"></i><span>All Loans</span>
              </a>
            </li>
            <li>
              <a href="/pendingloans">
                <i class="bi bi-circle"></i><span>Pending Loans</span>
              </a>
            </li>
            <li>
              <a href="/rejectedloans">
                <i class="bi bi-circle"></i><span>Rejected Loans</span>
              </a>
            </li>
            <li>
              <a href="/approvedloans">
                <i class="bi bi-circle"></i><span>Approved Loans</span>
              </a>
            </li>
            <li>
              <a href="/paidloans">
                <i class="bi bi-circle"></i><span>Paid Loans</span>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="/alltransactions" role="button">
            <i class="bi-person-badge"></i>
            <span class="nav-link-title" @if($active=='profile' ) style='color:#377dff' @endif>All Transactions</span>
          </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>SECUREloan</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
