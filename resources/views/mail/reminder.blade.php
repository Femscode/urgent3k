                ...
                <td style='text-align:center'>
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>PAY BACK YOUR LOAN, IT'S ALMOST DUE!!!</strong>
                        </div>
                        <div style="padding-bottom: 30px">
                            <p>
                                Hi, <strong>{{$name}}</strong> your borrowed loan ({{ $ref }})of the amount (NGN{{ $loan->totalamount }}) will be dued in {{ $loan->dayDifference }} days time. Kindly pay up
                                to avoid unneccessary interest and further legal actions. Thanks.
                            </p>
                            ...
                            <div
                                ...
                                <ul>
                                    <li>Loan Id : {{ $ref }}</li>
                                    <li>Amount : NGN{{ number_format($loan->amount) }}</li>
                                    <li>Status : <span style='color:red'>Yet to be paid</span></li>
                                </ul>
                            </div>
                        ...
                        <div style="padding-bottom: 40px; text-align:center;">
                            <a href="https://urgent3k.com/myloans" rel="noopener" target="_blank" rel="noopener"
