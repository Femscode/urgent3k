                ...
                <td style='text-align:center'>
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>FUNDS APPROVED</strong>
                        </div>
                        <div style="padding-bottom: 30px">
                            <p>
                                Hi, <strong>{{$name}}</strong> your fund request({{ $ref }}) has been approved. You will get credited in 5 to 10Min time.</p>
                            ...
                            <div
                                ...
                                <ul>
                                    ...
                                    <li>Status : <span style='color:green'>Approved</span></li>
                                </ul>
                            </div>
