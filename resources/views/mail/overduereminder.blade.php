                ...
                <td style='text-align:center'>
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>YOUR LOAN IS DUE!!!</strong>
                        </div>
                        <div style="padding-bottom: 30px">
                            <p>
                                Hi, <strong>{{$name}}</strong> your borrowed loan ({{ $ref }})of the amount (NGN{{ $loan->totalamount }}) has been dued for {{ $loan->dayDifference }}. Kindly pay up
