                ...
                <td style='text-align:center'>
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>FUND WITHDRAWAL REQUEST</strong>
                        </div>
                        <div style="padding-bottom: 30px">
                            <p>
                                Hi, <strong>{{$name}}</strong> your fund request({{ $ref }}) is being proceessed. You will get a report in 5 to 10Min time.</p>
                            ...
                            <div
                                ...
                                <ul>
                                    ...
                                    <li>Status : <span style='color:yellow'>Pending</span></li>
                                </ul>
                            </div>
