    ...
    <div class="card card-custom">
        ...
        <form class="form" method='post' action='{{ route("updateprofile") }}' enctype="multipart/form-data">@csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input readonly disabled type="text" class="form-control form-control-lg form-control-solid"
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input readonly required type="text" name='phone'
                ...
                <div class="form-group row mb-4">
                    <label class="col-xl-3 col-lg-3 col-form-label">Facebook Profile URL</label>
                    <div class="col-lg-9 col-xl-6">
                        <input required type='text' class='form-control' value="{{ $user->facebook ?? "" }}"
                            name='facebook' />
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label class="col-xl-3 col-lg-3 col-form-label">Instagram Profile URL <span
                ...
                <div class="form-group row mb-4">
                    <label class="col-xl-3 col-lg-3 col-form-label">X (Twitter) Profile URL</label>
                    <div class="col-lg-9 col-xl-6">
                        <input required type='text' class='form-control' value="{{ $user->twitter ?? "" }}"
                            name='twitter' />
                    </div>
                </div>
                <!--begin::Form Group-->
                ...
                <div style='border:1px dashed #004085;background-color:#cce5ff;color:#004085'
                    class=" alert alert-primary form-group row mb-4">
                    <label class="col-xl-3 col-lg-3 col-form-label">BVN</label>
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">

                            <input type="number" name='bvn' class="form-control form-control-lg form-control-solid"
                        ...
                        <ul>
                            ...
                            <li>To assign a <b>loan account</b> to you.</li>
                        </ul>
                    </div>
                </div>
                @else
