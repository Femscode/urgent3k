...
<!-- Mirrored from URGENT3K.createx.studio/landing-digital-agency.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Feb 2024 14:59:31 GMT -->
<!-- Added by HTTrack -->
...
<body>
  ...
  <main class="page-wrapper">
    ...
    <header class="header navbar navbar-expand-lg position-absolute navbar-sticky">
      <div class="container px-3">
        <a href="#" class="navbar-brand pe-3">
          ...
          <strong><span>URGENT3<span style='color:red'>K</span></span></strong>
        </a>
      ...
      <div class="container position-relative zindex-5 py-5">
        <div class="row justify-content-md-start justify-content-center">
          <div
            ...
            <div class="mb-md-5 pb-xl-5 mb-4">
              ...
              <div class="d-inline-flex align-items-center position-relative mb-3">
                ...
                <h4 class="mb-0">Need an  
                  {{-- <span class="text-gradient-primary">urgent 3K?</span> --}}
                  <span  style='color:#FF4500'>urgent 3K?</span>
                </h4>
              </div>

              <!-- Text -->

              <h1 style='text-align:left' class="display-4 mb-md-5 mb-3 pb-3">
                We know it's <span style='color:#FF4500'>urgent</span>, and we gat YOU!</span>
          ...
          <div class="col-sm-6 col-9 order-md-2 order-1">
            <img src='/assets/img/landing/thousand.png' width="100%"/>
    ...
    <section class="container pt-4 pt-lg-0 pb-4 pb-lg-5">
      <h2 class="h1 text-center pb-3 pb-md-0 mb-md-5">It takes only <span style='color:red'>3Mins</span> to get credited!</h2>
      <div class="steps">
        <div class="step pt-0 pt-md-3 pb-5">
          ...
          <div class="step-body d-flex align-items-center ps-xl-5">
            ...
            <div class="rellax ps-md-4 ps-xl-5" data-rellax-percentage="0.5" data-rellax-speed="0.4"
              ...
              <p class="mb-0">First, get yourself registered. Click <a href='/register'> here</a> to register .
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="step pt-0 pt-md-4 pb-5">
          ...
          <div class="step-body d-flex align-items-center ps-xl-5">
            ...
            <div class="rellax ps-md-4 ps-xl-5" data-rellax-percentage="0.5" data-rellax-speed="0.4"
              ...
              <h3 class="h4">Request For Your Urgent3k</h3>
              <p class="mb-0">After completing your KYC, you then request for your loan which will be credited within 2 to 3 Mins.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="bg-secondary rounded-3 py-5 px-3 px-md-0">
        <div class="row justify-content-center mb-2 py-md-2 py-lg-4">
          <div class="col-lg-10 col-md-11">
            <h2 class="pb-3">Why use URGENT3K?</h2>
              ...
              <div class="col">
                <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                  <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ps-4 ms-lg-3">
                      <h3 class="display-10 mb-1">Improve Credit Score</h3>
                      <p class="mb-0">We help boast your credit score to improve your credibility in the financial world.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                  <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ps-4 ms-lg-3">
                      ...
                      <p class="mb-0">You can always trust and rely on us in emergency situations.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="px-md-4 position-relative zindex-5">
                <div class="d-sm-flex align-items-start justify-content-between">
                  <div class="text-center text-sm-start me-sm-4">
                    <div class="lead fw-semibold text-light text-uppercase mb-2">Dear You,</div>
                    <h3 class="h1 text-light">WE GAT YOU!</h3>
                  </div>
      ...
      <div class="row gy-4 mb-4 pb-md-3 pb-2">
        ...
        <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 offset-lg-1 d-flex rellax" data-rellax-percentage="0.5" data-rellax-speed="-0.5" data-disable-parallax-down="md" style="transform: translate3d(0px, -20px, 0px);">
          <div class="align-self-center ps-lg-0 ps-md-4">
            <h4 class="mb-lg-4 mb-3 fs-base fw-normal text-body">urgent3k</h4>
            ...
            <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
              <h3 class="accordion-header" id="heading-1">
                <button class="accordion-button fs-xl shadow-none rounded-3" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">Can I borrow more than 3K?</button>
              </h3>
              <div class="accordion-collapse collapse show" id="collapse-1" aria-labelledby="heading-1"
                ...
                <div class="accordion-body pt-0">
                  <div class="d-flex flex-md-row flex-column align-items-md-center">
                    ...
                    <div class="ps-md-3">
                      <p class="mb-0">Yes! But as a new user, your can only borrow 3k first, and it will continue to increase as you continue using our services.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
              <h3 class="accordion-header" id="heading-2">
                <button class="accordion-button fs-xl shadow-none rounded-3 collapsed" type="button"
                  ...
                  aria-controls="collapse-2">When Am I Expected To Pay Back?</button>
              </h3>
                ...
                <div class="accordion-body pt-0">
                  <div class="d-flex flex-md-row flex-column align-items-md-center">
                    <img src="assets/img/landing/digital-agency/services/02.png" width="200" alt="Web Development"
                      class="me-md-4 mb-md-0 mb-3">
                    <div class="ps-md-3">
                      <p class="mb-0">We are borrowing you because we know it is urgent, and you're expected to pay back within five(5) days.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
              <h3 class="accordion-header" id="heading-3">
                <button class="accordion-button fs-xl shadow-none rounded-3 collapsed" type="button"
                  ...
                  aria-controls="collapse-3">What is the interest?</button>
              </h3>
              <div class="accordion-collapse collapse" id="collapse-3" aria-labelledby="heading-3"
                ...
                <div class="accordion-body pt-0">
                  <div class="d-flex flex-md-row flex-column align-items-md-center">
                    ...
                    <div class="ps-md-3">
                      <p class="mb-0">Our interest is just 8%, which means that for every 3k we charge NGN240</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
              <h3 class="accordion-header" id="heading-4">
                <button class="accordion-button fs-xl shadow-none rounded-3 collapsed" type="button"
                  ...
                  aria-controls="collapse-4">What if I don't pay back within five days?</button>
              </h3>
                ...
                <div class="accordion-body pt-0">
                  <div class="d-flex flex-md-row flex-column align-items-md-center">
                    <img src="assets/img/landing/digital-agency/services/04.png" width="200" alt="Strategy"
                      class="me-md-4 mb-md-0 mb-3">
                    <div class="ps-md-3">
                      <p class="mb-0">After five days, there is a daily increase of 2% on the amount you borrowed. (i.e for every 3k, there will be NGN60 increase everyday)</p>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from URGENT3K.createx.studio/landing-digital-agency.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Feb 2024 14:59:38 GMT -->
